...
const Footer = () => {
  return (
    // <div className='md:left-[10%] w-full mt-24 bg-black/70 text-gray-300 py-2 px-2'>
    <div className='w-full mt-24 bg-black/70 text-gray-300 py-2 px-2'>
      ...
      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4'>2023 MUAP Chauffuers, LLC. All rights reserved</p>
